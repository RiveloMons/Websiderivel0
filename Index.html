...
<script>
// 🔹 Aquí defines TODOS tus productos visibles para todos
let productos = [
  {
    titulo:"Ejemplo producto 1",
    descripcion:"Descripción real del producto 1",
    precio:"100",
  ...
  {
    titulo:"Ejemplo producto 2",
    descripcion:"Descripción real del producto 2",
    precio:"50",
    imagen:"https://via.placeholder.com/300",
    estado:"Usado",
    ubicacion:"Madrid"
...
// 🔹 Funciones para editar productos desde el panel
